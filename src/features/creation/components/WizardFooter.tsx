  ...
  return (
    <footer className="mt-10 flex flex-wrap items-center justify-between gap-3 border-t border-ink-red/30 pt-5">
      <button
        type="button"
        onClick={onCancel}
        className="font-label text-microlabel tracking-label uppercase text-ink-red/70 hover:text-ink-red underline-offset-4 hover:underline cursor-pointer focus:outline-none focus-visible:underline px-2 py-2.5"
      >
