...
export function DiceTrayLauncher() {
  ...
  return (
    ...
    >
      ...
      <span className="font-label text-eyebrow tracking-label uppercase">
        {t('dice.launcher.label')}
      </span>
      <kbd className="font-label text-microcaption tracking-label uppercase bg-ink-red-soft/40 px-1.5 py-0.5">
        D
      </kbd>
    </button>
  );
